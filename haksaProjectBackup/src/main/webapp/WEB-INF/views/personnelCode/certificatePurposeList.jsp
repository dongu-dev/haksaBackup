	...
	<body id="page-top">
		...
		<div id="wrapper">
			...
			<div id="content-wrapper">
				...
				<br>
					<p id="enrolScoreMain">* 증명서용도코드 리스트</p>
					<form id="form">
					...
					<table class="table table-bordered">
						...
						<tbody>
							<c:forEach var="personnel" items="${getCertificatePurposeList}">
								<tr>
									<td>${personnel.certificatePurposeCode}</td>
									<td>${personnel.certificatePurposeCodeName}</td>
									<td>${personnel.certificatePurposeChangeReasonCause}</td>
									<td>${personnel.certificatePurposePersonnelPayDivision}</td>
									<td>${personnel.certificatePurposeUseExistenceNonexistence}</td>
									<td>${personnel.certificatePurposeRegistrationDate}</td>
									<td>${personnel.certificatePurposeModificationDate}</td>
								</tr>
							</c:forEach>
						</tbody>
					</table>
